...
DOCUMENT_TYPE = NEUTRAL_SENTENCE_STRUCTURAL_REPORT · report_hash = bdeb25dc95 · GENERATOR = HUSSEIN_SCRIPT · RENDERER=TAAQOL_STYLE

## 2. الجملة محل التشغيل

> أَنَا عِنْدِي سُكَّرِيٌّ، وَأُرِيدُ أَنْ آكُلَ كِيلُو كُنَافَةٍ مَعَ آيْسْكْرِيم، فَهَلْ تُوَافِقُ؟
...
| --- | --- | --- |
| c000 | أَنَا عِنْدِي سُكَّرِيٌّ، | NO |
...
| --- | --- | --- | --- | --- |
| REQ-NEUTRAL-REPORT-JSON | OWNER_SUPPLIED_INPUT_SENTENCE | neutral_sentence_report_bdeb25dc95.json | tests/test_neutral_sentence_report_generator.py | TRACEABLE |
| REQ-NEUTRAL-REPORT-MD | OWNER_SUPPLIED_INPUT_SENTENCE | neutral_sentence_report_bdeb25dc95.md | tests/test_neutral_sentence_report_generator.py | TRACEABLE |
| REQ-NEUTRAL-REPORT-HTML | OWNER_SUPPLIED_INPUT_SENTENCE | neutral_sentence_report_bdeb25dc95.html | tests/test_neutral_sentence_report_generator.py | TRACEABLE |
