...
DOCUMENT_TYPE = NEUTRAL_SENTENCE_STRUCTURAL_REPORT · report_hash = a6d9d4bc56 · GENERATOR = HUSSEIN_SCRIPT · RENDERER=TAAQOL_STYLE
...
| --- | --- | --- |
| c000 | مَاتَ مَلِكٌ عَنْ أُخْتٍ سَاكِنَةٍ مَعَهُ، | NO |
| c001 | فَأَرَادَ وَارِثُهُ طَرْدَهَا، | NO |
...
| --- | --- | --- | --- | --- |
| REQ-NEUTRAL-REPORT-JSON | OWNER_SUPPLIED_INPUT_SENTENCE | neutral_sentence_report_a6d9d4bc56.json | tests/test_neutral_sentence_report_generator.py | TRACEABLE |
| REQ-NEUTRAL-REPORT-MD | OWNER_SUPPLIED_INPUT_SENTENCE | neutral_sentence_report_a6d9d4bc56.md | tests/test_neutral_sentence_report_generator.py | TRACEABLE |
| REQ-NEUTRAL-REPORT-HTML | OWNER_SUPPLIED_INPUT_SENTENCE | neutral_sentence_report_a6d9d4bc56.html | tests/test_neutral_sentence_report_generator.py | TRACEABLE |
