...
- عدد الكلمات (تقطيع سطحي) = 7 · عدد المرشحات البنيوية = 1.
...
DOCUMENT_TYPE = NEUTRAL_SENTENCE_STRUCTURAL_REPORT · report_hash = ae3a4a1556 · GENERATOR = HUSSEIN_SCRIPT · RENDERER=TAAQOL_STYLE
...
| --- | --- | --- |
| c000 | مات ملك عن أخت ساكنة معه فتحاكما | NO |
...
| --- | --- | --- | --- | --- |
| REQ-NEUTRAL-REPORT-JSON | OWNER_SUPPLIED_INPUT_SENTENCE | neutral_sentence_report_ae3a4a1556.json | tests/test_neutral_sentence_report_generator.py | TRACEABLE |
| REQ-NEUTRAL-REPORT-MD | OWNER_SUPPLIED_INPUT_SENTENCE | neutral_sentence_report_ae3a4a1556.md | tests/test_neutral_sentence_report_generator.py | TRACEABLE |
| REQ-NEUTRAL-REPORT-HTML | OWNER_SUPPLIED_INPUT_SENTENCE | neutral_sentence_report_ae3a4a1556.html | tests/test_neutral_sentence_report_generator.py | TRACEABLE |
