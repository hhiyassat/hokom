...
- عدد الكلمات (تقطيع سطحي) = 4 · عدد المرشحات البنيوية = 1.
...
DOCUMENT_TYPE = NEUTRAL_SENTENCE_STRUCTURAL_REPORT · report_hash = 287770ac72 · GENERATOR = HUSSEIN_SCRIPT · RENDERER=TAAQOL_STYLE
...
| --- | --- | --- | --- | --- |
| REQ-NEUTRAL-REPORT-JSON | OWNER_SUPPLIED_INPUT_SENTENCE | neutral_sentence_report_287770ac72.json | tests/test_neutral_sentence_report_generator.py | TRACEABLE |
| REQ-NEUTRAL-REPORT-MD | OWNER_SUPPLIED_INPUT_SENTENCE | neutral_sentence_report_287770ac72.md | tests/test_neutral_sentence_report_generator.py | TRACEABLE |
| REQ-NEUTRAL-REPORT-HTML | OWNER_SUPPLIED_INPUT_SENTENCE | neutral_sentence_report_287770ac72.html | tests/test_neutral_sentence_report_generator.py | TRACEABLE |
