...
- عدد الكلمات (تقطيع سطحي) = 14 · عدد المرشحات البنيوية = 3.
...
DOCUMENT_TYPE = NEUTRAL_SENTENCE_STRUCTURAL_REPORT · report_hash = ac38bf63c7 · GENERATOR = HUSSEIN_SCRIPT · RENDERER=TAAQOL_STYLE

## 2. الجملة محل التشغيل

> أَنَا مُهَنْدِسٌ، وَأُرِيدُ أَنْ أَحْذِفَ عَمُودًا مِنْ بِنَاءٍ قَائِمٍ دُونَ مُخَطَّطَاتٍ إِنْشَائِيَّةٍ، فَهَلْ تُوَافِقُ؟
...
| --- | --- | --- |
| c000 | أَنَا مُهَنْدِسٌ، | NO |
| c001 | وَأُرِيدُ أَنْ أَحْذِفَ عَمُودًا مِنْ بِنَاءٍ قَائِمٍ دُونَ مُخَطَّطَاتٍ إِنْشَائِيَّةٍ، | NO |
...
| --- | --- | --- | --- | --- |
| REQ-NEUTRAL-REPORT-JSON | OWNER_SUPPLIED_INPUT_SENTENCE | neutral_sentence_report_ac38bf63c7.json | tests/test_neutral_sentence_report_generator.py | TRACEABLE |
| REQ-NEUTRAL-REPORT-MD | OWNER_SUPPLIED_INPUT_SENTENCE | neutral_sentence_report_ac38bf63c7.md | tests/test_neutral_sentence_report_generator.py | TRACEABLE |
| REQ-NEUTRAL-REPORT-HTML | OWNER_SUPPLIED_INPUT_SENTENCE | neutral_sentence_report_ac38bf63c7.html | tests/test_neutral_sentence_report_generator.py | TRACEABLE |
